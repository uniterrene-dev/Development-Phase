...
<li <?php post_class(); ?>>
	<div class="products">
	    <div class="priductImg">
	      <div class="productHover">
	        <ul>
	          <li><a class="button yith-wcqv-button" href="#" data-product_id="<?php the_id(); ?>"> <i class="fa fa-eye" aria-hidden="true"></i>
	            <p>Quick View</p>
	            </a></li>
	 ...
	 */
	//do_action( 'woocommerce_after_shop_loop_item' );  //buttons
	?>
	</div>
          </div>
</li>
