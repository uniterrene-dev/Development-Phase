<?php
    ...
    */
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'phone',
                'type'     => 'text',
                'title'    => __( 'Phone Number (Displayed in top)', 'redux-framework-demo' ),
            ),

            array(
                'id'       => 'phone_bottom',
                'type'     => 'text',
                'title'    => __( 'Phone Number (Displayed in bottom)', 'redux-framework-demo' ),
            ),

            array(
                'id'       => 'phone_call',
                'type'     => 'text',
                'title'    => __( 'Phone Number (for Call)', 'redux-framework-demo' ),
                'desc'    => __( 'use suggested format: +1234567890', 'redux-framework-demo' ),
            ),

            array(
                'id'       => 'mail',
                'type'     => 'text',
                'title'    => __( 'Email Address (Displayed in top)', 'redux-framework-demo' ),
            ),

            array(
                'id'       => 'mail_bottom',
                'type'     => 'text',
                'title'    => __( 'Email Address (Displayed in bottom)', 'redux-framework-demo' ),
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type'     => 'text',
                'title'    => __( 'Banner button link', 'redux-framework-demo' ),
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'     => 'social-setting',
        'desc'   => __( 'Social media section for your site', 'redux-framework-demo' ),
        'icon'   => 'el el-globe',
        'fields' => array(
            array(
                'id'       => 'facebook',
    ...
    Redux::setSection( $opt_name, array(
        'title'  => __( 'Link Settings', 'redux-framework-demo' ),
        'id'     => 'link-setting',
        'desc'   => __( 'Speciality of tea link', 'redux-framework-demo' ),
        'icon'   => 'el el-link',
        'fields' => array(
            array(
                'id'       => 'special-link',
                'type'     => 'text',
                'title'    => __( 'Speciality of tea link', 'redux-framework-demo' ),
            ),
        )
    ) );
