...
-->
             ...
             <?php /*  <p class="book" style="display:none">
                 ...
                 <br />Note: In case of invalid address you will not see the book now option...<br />
                	...
                	Terms and Conditation<br>
                <?php $my_postid = 1075;//This is page id or post id
...
echo $content;?></p>
				...
				<ul class="buttonHolderUl">
					<li class="bookNow_"><button id="btn_yes" onClick="hideDiv()" class="Btns yes">BOOK NOW</button></li>
                    <li class="close_"><button id="btn_no" onClick="hideDiv_inni()"class="Btns no"><img src="http://onlinedevserver.biz/dev/Adelaide_limuisine/wp-content/themes/car-hire/images/close.png" alt=""></button></li>
               </ul>
               
               <ul>
					         <li style="display:inline-block"><a id="print" target="_blank"href="" class="Btns yes" style="display:block;background:#fff;padding:5px;;padding:5px;"><img src="http://onlinedevserver.biz/dev/Adelaide_limuisine/wp-content/themes/car-hire/images/print.png" alt=""></a></li>
                    <li style="display:inline-block"><a id="pdf" target="_blank" href="" class="Btns yes" style="display:block;background:#fff;padding:5px;;padding:5px;"><img src="http://onlinedevserver.biz/dev/Adelaide_limuisine/wp-content/themes/car-hire/images/pdf.png" alt=""></a></li>
               </ul>
