...
?>
			...
			<div style="background:url('<?php //echo get_template_directory_uri(); ?>/images/Letter Head ( ALHC)  copy.jpg'); text-align:center;height:100vh; background-size:contain; width:100%; background-repeat: no-repeat;background-position:center center;">
				<img style="width:auto;height:100vh;" src="<?php echo get_template_directory_uri(); ?>/images/letter_Head_without_logo.jpg"/>
				
				

			<div class="quoation_price" style="position:absolute;top:0;left:0;right:0;bottom:0;">
				<img style="width:64%; " src="<?php echo get_template_directory_uri(); ?>/images/letter_Head_logo.jpg"/>
<!--
				<img style="width:64%;" src="<?php //echo get_template_directory_uri(); ?>/images/letter_Head_bottom.jpg"/>
-->
...
<div style="border-top: 2px dotted #444;float: left; margin: 20px 0 45px 0;width:100%; font-size:14px;">

<div class="description" style="width:46%;margin-right:2px solid black; float:left;padding: 40px 0 0 50px; border-right:2px dotted #444; text-align:left;" >
...
<div class="description" style="width:44%;margin-right:2px solid black; float:right;padding: 40px 0 0 20px; text-align:left;" >
...
<div class="devider-box" style="width:20%; float:left; font-size:22px; padding:40px 0;">
...
<div class="description" style="width:46%;margin-right:2px solid black; float:right;padding: 40px 0 0 20px; text-align:left;" >
