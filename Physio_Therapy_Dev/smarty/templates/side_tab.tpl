...
<table style="position: absolute;top: 84;left: 0;" border="0" width="100%" height="100%" cellspacing="-1">
  <tr>
    ...
    <td valign="top" width="50%" bgcolor="#fcfcfc" rowspan="2">
      <div id="listContainer" class="navigation">
        <ul >
	  <li class="has-sub"><a href="#">Conditions</a>
	    <ul >
            {$cond_data}
	    </ul>
	  </li>
	  <li class="has-sub"><a href="#">Bodyparts</a>
	    <ul >
            {$bp_data}
	    </ul>
          </li>
	  <li class="has-sub"><a href="#">Positions</a>
	    <ul >
            {$pos_data}
	    </ul>
          </li>
	  <li class="has-sub"><a href="#">Purpose</a>
	    <ul >
            {$purpose_data}
	    </ul>
          </li>
	  <li class="has-sub"><a href="#">Equipments</a>
	    <ul >
            {$equip_data}
	    </ul>
          </li>
