<?php
/* Smarty version 3.1.30, created on 2017-02-04 12:55:15
  from "C:\xampp\htdocs\Physio_Therapy_Dev\smarty\templates\home.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5895c123e378e1_42385822',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1678ef8b53332b99540b0968e5a2437f7d3077d8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Physio_Therapy_Dev\\smarty\\templates\\home.tpl',
      1 => 1485762384,
      2 => 'file',
    ),
  ),
...
function content_5895c123e378e1_42385822 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<link rel="stylesheet" href="static/home/css/custom_slide.css">
			...
			<!-- Header Right -->
				<div class="col-md-3 col-sm-3 col-xs-12 navbar-right text-right">
					<div class="headerRight">
						...
						<button class="btn btn-warning btn-signout"><img src="static/home/images/signout.png" alt="">Signout</button>
					</div>
				</div>
			<!-- Header right Ends -->
				...
				<div class="slidearea showEnglish clearfix">
					...
					<div class="col-md-6">
						<div class="photosAndVideosArea">
							...
							<div class="tab-content">
							    <div role="tabpanel" class="tab-pane active" id="photos">
							    	<ul class="list-inline clearfix">							    	
							    		<li class="col-md-12"> <div class="imgWrap"><img src="static/home/images/6_1png.jpg" class="stepImageOnPop" alt=""></div>
							    ...
							    <div role="tabpanel" class="tab-pane" id="videos">
							    	<ul class="list-inline clearfix">							    	
							    		<li class="col-md-12"> <div class="imgWrap"><img src="static/home/images/gif_video_1.gif" class="stepImageOnPop" alt=""></div>
							...
							<div class="flipArea">
								<ul class="list-inline">
									<li><a href="javascript:void(0)" ><img src="static/home/images/rotate.png" title="Flip Image"/></i></a>
							...
							<div class="thumbnailArea thumbsForImage">
								<ul class="list-inline">
									<!-- <li class="activeThumb"><a href="javascript:void(0)" ><img src="static/home/images/photos_thumb1.jpg" title="Thumbnail"></i></a></li>
									<li class=""><a href="javascript:void(0)" ><img src="static/home/images/thumb2.jpg" title="Thumbnail"></i></a></li>
									<li class=""><a href="javascript:void(0)" ><img src="static/home/images/thumb1.jpg" title="Thumbnail"></i></a></li> -->
								</ul>
							</div>

							<div class="thumbnailArea thumbsForVideos">
								<ul class="list-inline">
									<li class="activeThumb"><a href="javascript:void(0)" ><img src="static/home/images/video_thumb1.jpg" title="Thumbnail"></i></a></li>
									<li class=""><a href="javascript:void(0)" ><img src="static/home/images/video_thumb2.jpg" title="Thumbnail"></i></a></li>
									<li class=""><a href="javascript:void(0)" ><img src="static/home/images/video_thumb1.jpg" title="Thumbnail"></i></a></li>
								</ul>
							</div>
						</div>
							...
							<li><a class="" href="javascript:void(0)">Position<i class="fa fa-plus"></i></a>
									<ul class="child mainChild mainChild_hide">
                                     <?php echo $_smarty_tpl->tpl_vars['pos_data']->value;?>
										...
										<!--<li><a class="" href="javascript:void(0)">Supine</a></li>									
										<li><a class="" href="javascript:void(0)">Side Lying</a></li>									
										<li><a class="" href="javascript:void(0)">Prone</a></li>									
										<li><a class="" href="javascript:void(0)">Quadruped</a></li>									
										<li><a class="" href="javascript:void(0)">Sit</a></li>									
										<li><a class="" href="javascript:void(0)">Kneel</a></li>									
										<li><a class="" href="javascript:void(0)">Half Kneel</a></li>									
										<li><a class="" href="javascript:void(0)">Stand</a></li>-->
									</ul>
							</li>
							<!-- appendPoint area -->
								<div class="appendPoint"></div>
						...
						<ul class="list-inline clearfix">
							<li class="col-md-2 items dragable_Items" title="Click and drag">
								<div class="itemWrap items">
									<div class="imageArea">
										<img src="static/home/images/6_1png.jpg" alt="">
									</div>
									<div class="ExName">
									...
									<!-- description -->
										<div class="itemDescription">
											...
											<ul>
												<li><img src="static/home/images/6_1png.jpg" alt="#">
													<div class="SlideInfo">
														<span>Step 1: </span> Sit in a chair, lean forward to reach for left ankle
													</div>
												</li>												
												<li><img src="static/home/images/6_2png.jpg" alt="#">
													<div class="SlideInfo">
														<span>Step 2: </span> Hold your left ankle with right hand.
													</div>
												</li>
												
												<li><img src="static/home/images/6_3png.jpg" alt="#">
													<div class="SlideInfo">
												...
												<li><img src="static/home/images/6_4png.jpg" alt="#">
													<div class="SlideInfo">
											...
											<!-- <ul class="list-inline thumb_holder_pop">
												<li class="currnetPopThumb"><img src="static/home/images/thumb1.jpg" alt="">
													<span>Step 1</span>
												</li>
												<li><img src="static/home/images/thumb2.jpg" alt="">
													<span>Step 2</span>
												</li>
												<li><img src="static/home/images/thumb1.jpg" alt="">
													<span>Step 3</span>
												</li>
											</ul> -->
										</div>
							...
							<li class="col-md-2 items dragable_Items" title="Click and drag">
								<div class="itemWrap items">
									<div class="imageArea">
										<img src="static/home/images/item2.jpg" alt="">
									</div>
									<div class="ExName">
										<ul class="list-inline customList">
							...
							<li class="col-md-2 items dragable_Items" title="Click and drag">
								<div class="itemWrap items">
									<div class="imageArea">
										<img src="static/home/images/item3.jpg" alt="">
									</div>
									<div class="ExName">
										<ul class="list-inline customList">
											<li><h4>Supine Hamstring Stretch with Strap</h4>
									...
									<!-- description -->
										<div class="itemDescription">
											...
											<div class="videoPlaceholder">
												<img src="static/home/images/gif_placeholder.png" alt="#">
											</div>
							...
							<li class="col-md-2 items dragable_Items" title="Click and drag">
								<div class="itemWrap items">
									<div class="imageArea">
										<img src="static/home/images/item4.jpg" alt="">
									</div>
									<div class="ExName">
										<ul class="list-inline customList">
											<li><h4>Supine Hamstring Stretch with Strap</h4>
							...
							<li class="col-md-2 items dragable_Items" title="Click and drag">
								<div class="itemWrap items">
									<div class="imageArea">
										<img src="static/home/images/item5.jpg" alt="">
									</div>
									<div class="ExName">
										<ul class="list-inline customList">
											<li><h4>Supine Hamstring Stretch with Strap</h4>
							...
							<li class="col-md-2 items dragable_Items" title="Click and drag">
								<div class="itemWrap items">
									<div class="imageArea">
										<img src="static/home/images/item6.jpg" alt="">
									</div>
									<div class="ExName">
										<ul class="list-inline customList">
											<li><h4>Supine Hamstring Stretch with Strap</h4>
							...
							<li class="col-md-2 items dragable_Items" title="Click and drag">
								<div class="itemWrap items">
									<div class="imageArea">
										<img src="static/home/images/item1.jpg" alt="">
									</div>
									<div class="ExName">
										<ul class="list-inline customList">
											<li><h4>Supine Hamstring Stretch with Strap</h4>
...
<!-- footer -->
	<footer class="clearfix">
		...
		<h2>PHYSICAL THERAPY HOME EXERCISE PROGRAM</h2>
		 <span>Mail us:<a href="javascript:void(0)"> abc@gmail.com </a></span>
		<p>Disclaimer: All the exercises should be performed the guidance of a physical therapist, the home exercise program does not take any ownership of any liability for injury.</p>
		</div>
	</footer>
<!-- footer ends -->
...
>
<?php echo '<script'; ?>
 src="static/home/js/bootstrap.min.js"><?php echo '</script'; ?>
>	
<?php echo '<script'; ?>
 src="http://code.jquery.com/ui/1.12.1/jquery-ui.min.js"><?php echo '</script'; ?>
>
<!-- <?php echo '<script'; ?>
 src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js"><?php echo '</script'; ?>
> -->
<?php echo '<script'; ?>
 src="static/home/js/custom_slide.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="static/home/js/functions.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://cdn.tinymce.com/4/tinymce.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
>tinymce.init({ selector:'textarea',force_p_newlines : true });
