$(document).ready(function() {
    ...
    $('.placeholderForDrop').droppable({
        drop: function() {
            ...
            $('.minPanelWrapper li#' + removeIte).remove();
...
$('#body_parts ul li ul li ul li a').bind('click', function() {
   if ($(this).next().hasClass('childs') == true) {
    ...
    //===========================================
    $(window).resize(function (arguments) {
...
//     goForSlide();
// });
// $('.itemWrap.items').bind('mouseenter',itemSlider(400, $('.videoPlaceholder') ));




// function itemSlider(sildeTime, divToSlide){
//     var sliderTime = sildeTime;
//     var sliderHolde = divToSlide; //$('.videoPlaceholder');
    
//     sliderHolde.find('li').first().addClass('currentSlide');
