    ...
    <header id="header">
        ...
        <div class="logo_area">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php bloginfo('title'); ?>">
                <?php if(!empty($oregon_options['logo'])) { ?> <img src="<?php echo $oregon_options['logo']['url']; ?>"> <?php } ?>
            </a>
        </div>
        <!-- banner header -->
        <div class="head_text">
        ...
        <div class="down_arrow">
            <a class="circle" href="#introduction"><img src="<?php echo bloginfo('template_directory'); ?>/images/downarrow.png"></a>
        </div>
