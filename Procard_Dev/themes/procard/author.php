...
get_header(); ?>
		...
		<section class="inner-div clearfix">
			<div class="container">
				<h2 class="page-title author inner-page-heading"><span><?php printf( __( 'Author Archives: %s', 'procard' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></span></h2>
