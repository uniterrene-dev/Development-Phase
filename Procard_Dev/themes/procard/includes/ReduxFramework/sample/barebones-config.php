<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'blog_title',
                'type'     => 'text',
                'title'    => __( 'Main blog page title', 'redux-framework-demo' ),
            ),

            array(
                'id'       => 'blog_link',
                'type'     => 'text',
                'title'    => __( 'Blog page slug here', 'redux-framework-demo' ),
                'description' => __('To be used for View More button on home page (keep the page slug of blog page for example "blog") '),
            ),
            ...
            array(
                'id'       => 'google-map',
                'type'     => 'editor',
                'title'    => __( 'Google map iframe', 'redux-framework-demo' ),
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'banner',
                'type'     => 'slides',
                'title'    => __( 'Upload banner images', 'redux-framework-demo' ),
                'desc'     => __( 'Please optimize the images before you upload, as higher resolution images may lead to loading issues', 'redux-framework-demo' ),
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        'title' => __( 'Top Links', 'redux-framework-demo' ),
        'id'    => 'top-link-settings',
        'desc'  => __( 'Top links for your site', 'redux-framework-demo' ),
        'icon'  => 'el el-globe',
        'fields'     => array(
            array(
                'id'       => 'woo-account',
                'type'     => 'text',
                'title'    => __( 'Woocommerce My Account Link', 'redux-framework-demo' ),
                'description' => __('(please keep page slug only)', 'redux-framework-demo'),
            ),

            array(
                'id'       => 'woo-cart',
                'type'     => 'text',
                'title'    => __( 'Woocommerce Cart Link', 'redux-framework-demo' ),
                'description' => __('(please keep page slug only)', 'redux-framework-demo'),
            ),
        )
    ) );
