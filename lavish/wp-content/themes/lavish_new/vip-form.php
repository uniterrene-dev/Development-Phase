    ...
    <form>
      ...
      <div class="vip-form-box-right clearfix">
       ...
       <li class="vip-form-box-field">
        ...
        <div class="vip-fields"> 
           <select>
             <option value="Lavish">Lavish $150</option>
             <option value="Silver">Silver $100k</option>
             <option value="Gold">Gold $250k</option>
             <option value="Platinum">Platinum $500k</option>
             <option value="Black">Black $1mill</option>
           </select> 
        </div>
       </li>
       <li class="vip-form-box-field">
